...
impl AccountsScan for SurfpoolAccountsScanRpc {
    ...
    fn get_token_largest_accounts(
        ...
        Box::pin(async move {
            match remote_ctx {
                Some((remote_client, _commitment)) => {
                    let token_balances = remote_client
                        .client
                        .get_token_largest_accounts(&mint_pubkey)
                        .await
                        .map_err(|_| JsonRpcCoreError::internal_error())?;
                ...
                None => {
                    let SvmAccessContext {
                        ...
                        ..
                    } = svm_locker.get_token_largest_accounts(&mint_pubkey)?;
